...
```{r plot storeys and price with filtered data, echo = FALSE}
...
```{r plot towns and price with filtered data, echo = FALSE}
...
```{r plot flat type and price with filtered data, echo = FALSE}
